...
class Config:
    ...
    ERROR_LOGGING_CHANNEL: int = 1017276639329144904  # Error tracebacks will be sent here if specified

    DB_BACKUP_CHANNEL: int = 1017276639329144904  # DB backups will be sent here if specified
