...
dotenv.load_dotenv()
weather_key = "238d83ab596b4d0f85f70cc76cc87f51"
...
async def weather(ctx: lightbulb.Context, city) -> None:
    ...
    embed.set_footer("Data provided by: OpenWeatherMap.org, Please Return Carrier Cassowary aka CaCa", icon="https://upload.wikimedia.org/wikipedia/commons/1/15/OpenWeatherMap_logo.png")
