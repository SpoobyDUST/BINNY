...
@lightbulb.command("stats", "Get statistics info of the BINNY.", auto_defer = True)
...
async def stats(ctx: lightbulb.Context) -> None:
    ...
    em.set_thumbnail('http://naturalbridgezoo.com/wp-content/uploads/2017/03/Cassawary3.jpg')
    em.set_footer('Please Return Carrier Cassowary aka CaCa')
    em.add_field(
