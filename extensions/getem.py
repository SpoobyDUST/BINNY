...
roast_plugin = lightbulb.Plugin("BINNY McNastyBottom", "Has been roastin since 03!")

@roast_plugin.command()
@lightbulb.add_cooldown(3, 3, lightbulb.UserBucket)
@lightbulb.option("member", "The user you want to roast!", hikari.Member, required=True)
@lightbulb.command("getem", "For all kinds of jokes! (Some might be offensive, be careful.)", auto_defer = True)
