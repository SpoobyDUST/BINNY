...
music = Music()
music_plugin = lightbulb.Plugin("Music Player, Binny Becomes a DJ" )
...
### Bot Commands
@slash.command(name="join", description="DUST joins your voice channel.")
...
@slash.command(name="leave", description="DUST leaves your voice channel.")
...
@slash.command(name="pause", description="DUST pauses the currently playing track.")
...
@slash.command(name="resume", description="DUST resumes the currently playing track.")
...
@slash.command(name="stop", description="DUST stops the currently playing track.")
...
@slash.command(name="skip", description="DUST skips the currently playing track.")
...
@slash.command(name="queue", description="DUST shows you the queue.")
...
@slash.command(name="shuffle", description="DUST shuffles the queue.")
...
@slash.command(name="nowplaying", description="DUST shows you the currently playing song.")
...
@slash.command(name="volume", description="DUST adjusts the volume.")
...
@slash.command(name="remove", description="DUST removes a track from the queue.")
...
@slash.command(name="skipto", description="DUST skips to a specific track in the queue.")
...
@slash.command(name="empty", description="DUST empties the queue.")
...
@slash.command(name="loop", description="DUST loops the currently playing track.")
...
@slash.command(name="queueloop", description="DUST loops the current queue.")
...
@slash.command(name="newreleases", description="DUST shows you the newly released tracks of the day.")
...
@slash.command(name="trending", description="DUST shows you the trending tracks of the day.")
...
@slash.command(name="support", description="Stock Trading Support Server!")
...
@slash.command(name="invite", description="Invite DUST to other servers!")
...
@slash.command(name="search", description="DUST searches Spotify for tracks!")
...
@slash.command(name="lyrics", description="DUST finds lyrics for (almost) any song!")
...
@slash.command(name="play", description="DUST plays your desired song.")
...
@slash.command(name="url", description="DUST plays an album, playlist or track from a Spotify URL.")
